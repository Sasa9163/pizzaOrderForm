...
<body class="bg-light">
	<div class="container">
		...
		<div class="m-3">
			<h1 class="border-bottom border-primary text-center">注文確認画面</h1>
		</div>
		<div class="row">
			...
			<div class="col-md-8 order-md-1">
				...
				<form action="<%=request.getContextPath()%>/OrderResultServlet"
					method="post">
					<div class="mb-3">
					...
					<hr class="mb-4">
					<button class="btn btn-primary btn-lg btn-block" type="submit">注文を確定する</button>
				</form>
				<hr class="mb-4">
			</div>
		</div>
